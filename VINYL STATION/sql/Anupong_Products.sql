...
CREATE TABLE `products` (
  ...
  `detail` text NOT NULL,              -- รายละเอียดแผ่น
  `category` varchar(100) DEFAULT 'Other', -- แนวเพลง (เช่น Pop, R&B, Rock)
  ...
  `spotify_url` varchar(500) DEFAULT NULL, -- ลิงก์ Spotify ของแผ่นเสียง
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- สร้างตารางสำหรับเก็บข้อมูลแอดมิน (Login)
CREATE TABLE `users` (
