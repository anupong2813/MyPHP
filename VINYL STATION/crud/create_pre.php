...
$img_url = trim($_POST['img_url'] ?? ''); $spotify_url = trim($_POST['spotify_url'] ?? '');
...
<div class="container">
    ...
    <div class="preview-layout">
        <div class="preview-img">
            <?php if ($preview_img): ?><img src="../<?= e($preview_img) ?>" alt="Preview"><?php else: ?><div class="no-cover">NO COVER</div><?php endif; ?>
        </div>
        <div class="preview-info">
            ...
            <p><strong>Spotify URL</strong> <?= e($spotify_url) ?: '-' ?></p>
