...
$sql = "UPDATE products SET productname = :n, detail = :d, price = :p, img = :i, color = :c, format = :f, released_date = :r, spotify_url = :s WHERE id = :id";
...
<div class="success-card">
    ...
    <div class="btn-group">
        <a href="../views/list.php" class="btn-primary">กลับไปยังคอลเลกชัน</a>
    </div>
</div>
</body>
</html>